...
mycharacter2* charac2;
QString path1[16]={":/icons/icon1.png",
                   ":/icons/icon2.png",
                   ":/icons/icon3.png",
                   ":/icons/icon4.png",
                   ":/icons/icon5.png",
                   ...
                   ":/icons/icon15.png",
                   ":/icons/icon16.png"};
QString path2[16]={":/icons/icon1-1.png",
                   ":/icons/icon2-1.png",
                   ":/icons/icon3-1.png",
                   ":/icons/icon4-1.png",
                   ":/icons/icon5-1.png",
                   ...
                   ":/icons/icon15-1.png",
                   ":/icons/icon16-1.png"};
chooseIcon::chooseIcon(QWidget *parent) : QMainWindow(parent)
{
...
//    **进入B的取名界面**
    ...
    for(int i=0;i<16;i++){
        ...
        connect(icon[i],&QPushButton::clicked,[=](){
            ...
            which=i;
            A.setIcon(icon[i]->common);
            icon[i]->beClicked();
        });
    }

    //从下一个页面回来
    connect(charac2,&mycharacter2::myCharacter2Back,[=](){
        charac2->hide();
        this->show();
    });
...
void chooseIcon::paintEvent(QPaintEvent *event){
